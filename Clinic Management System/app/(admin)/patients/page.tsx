...
export default function AdminPatientsPage() {
  ...
  const handleDelete = async (id: number) => {
    if (!confirm("Are you sure you want to delete this patient? This will also delete their membership and appointment records.")) return;
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert("Patient and related records deleted successfully!");
      } else {
        alert(result.error || "Failed to delete patient. They may have associated records.");
      }
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Patients (Admin)</h1>
